...
RUN apt-get update \
  ...
  && useradd dkube \
  && echo "dkube:dkube" | chpasswd \
	&& mkdir /home/dkube \
	&& chown dkube:dkube /home/dkube \
	&& addgroup dkube staff \
  ...
  && mkdir -p /home/dkube/.rstudio/monitored/user-settings \
  && echo 'alwaysSaveHistory="0" \
          \nloadRData="0" \
          \nsaveAction="0"' \
          > /home/dkube/.rstudio/monitored/user-settings/user-settings \
  && chown -R dkube:dkube /home/dkube/.rstudio
